...
impl FromWorld for Deploy{
    fn from_world( _world: &mut World ) -> Self {
        let cover_path: &str = "src/deploy/tilemap_tile_cover_config.json";
        let ground_path: &str = "src/deploy/tilemap_tile_ground_config.json";
        //let scene_path: &str = "src/deploy/scene_config.json";
        let biome_path: &str = "src/deploy/biome_config.json";
        let ground_scene_path: &str = "src/deploy/game_scene_config.json";
        let objects_path: &str = "src/deploy/game_objects_config.json";
